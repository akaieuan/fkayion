...
interface FracturingOctahedronProps {
...
export function FracturingOctahedron({ position, size, intensity, isActive }: FracturingOctahedronProps) {
  ...
  const material = new THREE.ShaderMaterial({
    uniforms: {
      ...
      baseColor: { value: new THREE.Color('#2299ff') }, // Cyan-blue (unique)
      crystalColor: { value: new THREE.Color('#44bbff') }, // Brighter cyan
