...
export function MeltingSphere({ position, size, intensity, isActive }: MeltingSphereProps) {
  const meshRef = useRef<THREE.Mesh>(null)
  
  // Enhanced melting shader 
  const material = new THREE.ShaderMaterial({
    uniforms: {
      time: { value: 0 },
      heatLevel: { value: 0 },
      intensity: { value: intensity },
      baseColor: { value: new THREE.Color('#ff3366') }, // Red-pink (unique)
      hotColor: { value: new THREE.Color('#ff5577') }, // Brighter red-pink
