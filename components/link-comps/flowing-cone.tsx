...
import { Float, Cone } from '@react-three/drei'
import * as THREE from 'three'

interface FlowingConeProps {
...
export function FlowingCone({ position, size, intensity, isActive }: FlowingConeProps) {
  ...
  const material = new THREE.ShaderMaterial({
    uniforms: {
      ...
      baseColor: { value: new THREE.Color('#44aa77') },
      liquidColor: { value: new THREE.Color('#55ddbb') },
