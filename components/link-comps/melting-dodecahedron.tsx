...
interface MeltingDodecahedronProps {
...
export function MeltingDodecahedron({ position, size, intensity, isActive }: MeltingDodecahedronProps) {
  ...
  const material = new THREE.ShaderMaterial({
    uniforms: {
      ...
      baseColor: { value: new THREE.Color('#ff6633') }, // Orange (unique)
      hotColor: { value: new THREE.Color('#ff8844') }, // Brighter orange
