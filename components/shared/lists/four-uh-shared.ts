/** Minimal scroll shell for 4UH panels — thin, readable */
export const fourUhScrollPanelClass =
  'w-full h-full min-h-0 overflow-y-auto overflow-x-hidden overscroll-y-contain pr-2 pb-2 sm:pb-3 text-[12px] leading-snug'
