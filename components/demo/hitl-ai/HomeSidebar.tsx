...
export function HomeSidebar({ onCollapse, onNavigate, activeView }: HomeSidebarProps) {
  ...
  const navItems = [
    ...
    { icon: GraduationCap, label: 'Deep Research' },
    { icon: PenLine, label: 'Write Doc' },
    { icon: Highlighter, label: 'Annotate', action: () => onNavigate('annotate') },
  ];
