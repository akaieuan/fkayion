...
export function HitlCard({ config, onOpenTab }: HitlCardProps) {
  ...
  if (state === 'confirmed') {
    return (
      <div className="my-1.5 flex items-center gap-2 rounded-xl border border-border px-3 py-1.5 text-xs">
  ...
  return (
    <div className="my-1.5 rounded-xl border border-border text-xs">
      <button
