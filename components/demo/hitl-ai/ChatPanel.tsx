...
export function ChatPanel({ onOpenTab }: ChatPanelProps) {
    ...
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="shrink-0 border-t border-border px-3 py-2">
        <div className="flex items-end gap-2">
          <button className="mb-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-muted-foreground hover:bg-muted transition-colors">
