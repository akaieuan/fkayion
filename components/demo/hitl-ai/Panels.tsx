...
import { Search, ZoomIn, ZoomOut, ChevronLeft, ChevronRight, FileText } from 'lucide-react';
...
export function NotesPanel() {
  ...
  const toggleGroup = (title: string) =>
    setOpenGroups((prev) => { const n = new Set(prev); n.has(title) ? n.delete(title) : n.add(title); return n; });
