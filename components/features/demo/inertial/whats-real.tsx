...
export function WhatsRealSection() {
  return (
          <section className="space-y-4">
            <h2 className="aka-lead">What&apos;s real</h2>
            <ul className="aka-list space-y-2.5">
              <li>
                ...
                <code className="aka-code">@inertial/schemas</code>): <code className="aka-code">ContentEvent</code>,{' '}
                <code className="aka-code">StructuredSignal</code>, <code className="aka-code">AgentTrace</code>,{' '}
                <code className="aka-code">ReviewItem</code>, <code className="aka-code">ReviewDecision</code>,{' '}
                <code className="aka-code">Policy</code>, <code className="aka-code">AuditEntry</code>,{' '}
                <code className="aka-code">SkillRegistration</code>, <code className="aka-code">GoldEvent</code>,{' '}
                <code className="aka-code">EvalRun</code>, <code className="aka-code">SkillCalibration</code>,{' '}
                <code className="aka-code">ReviewerTag</code> + scope, <code className="aka-code">TagAgreement</code>.
              </li>
              <li>
              ...
              <li>
                <strong className="font-medium text-foreground/85">A YAML policy evaluator with hash-chained{' '}
                  <code className="aka-code">/verify</code></strong>. Per-instance, structured AST (no string eval).
                Leaves are <code className="aka-code">channel + op + value</code> or{' '}
                <code className="aka-code">entity + present</code>; nodes compose with{' '}
                <code className="aka-code">all</code> / <code className="aka-code">any</code>; first match wins. The
              ...
              <li>
                <strong className="font-medium text-foreground/85">An eval harness scoring per-(skill, channel) Brier /
                  ECE / agreement</strong>. <code className="aka-code">pnpm eval</code> boots an in-memory pipeline,
                dispatches the 31-event gold set (
                <code className="aka-code">config/evals/gold-set-v1.jsonl</code> — 27 text + 3 image + 1 video)
                against the live skill registry, and prints calibration as a hash-chained artifact, not vibes. Reviewer
                commits auto-promote via <code className="aka-code">signalFeedback</code> +{' '}
                <code className="aka-code">reviewerTags</code> into <code className="aka-code">gold_events</code> (
                source <code className="aka-code">reviewer-derived</code>), so the corpus grows on every decision.
              </li>
              <li>
                <strong className="font-medium text-foreground/85">A reviewer-tag layer with per-modality / per-segment
                  scope</strong>. <code className="aka-code">TAG_CATALOG</code> ships ~18 starter tags;{' '}
                <code className="aka-code">reviewer_tags</code> stores them with scope; the &quot;good video, bad
              ...
              <li>
                ...
                <code className="aka-code">@inertial/db</code> is 14 tables on Postgres + pgvector with a pglite dev
                factory and 68 hermetic integration tests. Every state transition writes one entry per instance with{' '}
                <code className="aka-code">prevHash → hash</code> linkage. &quot;No remote API touched my instance over
