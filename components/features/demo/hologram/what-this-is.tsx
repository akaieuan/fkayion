  ...
  return (
          <section className="space-y-3">
            ...
            <p>
              ...
              <code className="aka-code">.glb</code> assets. The Claude Code plugin wraps all of it in
              guided skills (<code className="aka-code">/hologram:start</code>, inspect, check, status,
