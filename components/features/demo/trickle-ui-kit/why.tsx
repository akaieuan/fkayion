  ...
  return (
          <section className="space-y-4">
            ...
            <p>
              ...
              Install <code className="aka-code">framer-motion</code>{' '}
              to fade in a heading and you&apos;ve added 30kb of runtime JS to your bundle and forced every
              parent into a <code className="aka-code">&apos;use client&apos;</code> boundary. The animation engine wants to live in your application&apos;s runtime, with
