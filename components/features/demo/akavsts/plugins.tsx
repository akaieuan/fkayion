...
/** The three plugin write-ups. Moved verbatim from app/demo/akavsts/page.tsx (a fragment renders nothing, so the sections stay direct children of the article). */
