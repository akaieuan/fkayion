/** The closing card: the interesting part. Moved verbatim from app/demo/box-populi/page.tsx. */
export function BoxPopuliClosing() {
  return (
          <section className="aka-card-well px-5 py-4">
            <h2 className="aka-lead">The interesting part</h2>
