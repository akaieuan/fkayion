        ...
        <div className="site-inset max-w-site mx-auto w-full">
          ...
          >
            ...
            <div className="flex flex-col gap-5 md:order-1">
              ...
              <p
                className={`text-11 font-light tracking-wide text-foreground/60 ${reveal}`}
              ...
              <div className={`flex flex-wrap items-center gap-5 ${reveal}`} style={staggerDelay(3)}>
                {keyLinks.map((link) => (
                  <a
                    ...
                    className="text-13 font-light text-muted-foreground/75 transition-colors hover:text-primary"
                  >
                    {link.label}
                  </a>
                ))}
