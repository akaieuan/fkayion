        ...
        {items.map((row, i) => (
          <li key={row.href}>
            ...
            >
              ...
              <span className="mt-0.5 block text-13 font-light leading-relaxed text-muted-foreground/75 transition-colors duration-200 group-hover:text-muted-foreground/80">
                {row.meta}
              </span>
            </a>
          </li>
