        ...
        <section className="mt-16">
          ...
          <div className={`${cardCls} mt-6`}>
            ...
            <p className="mt-4 text-12 font-light leading-relaxed text-muted-foreground/70">
              ...
              <code className="aka-code">--stamp-ground</code> steps <em>down</em> from the page in
          ...
          <div className={`${cardCls} mt-3`}>
            <p className="aka-label">Palettes that belong to one drawing</p>
            <p className="mt-2 text-13 font-light leading-relaxed text-muted-foreground">
              ...
              <code className="aka-code">--bp-*</code>, which carries Blockpad&apos;s dark and light
              icon masters, and <code className="aka-code">--pixel-face-*</code>, which re-homes the
          ...
          <div className={`${cardCls} mt-3`}>
            <p className="aka-label">The one exception to Tailwind</p>
            <p className="mt-2 text-13 font-light leading-relaxed text-muted-foreground">
              An artefact ported in from elsewhere keeps its own stylesheet, scoped to a class, the
              way <code className="aka-code">app/trickle.css</code> keeps the kit&apos;s keyframes and{' '}
              <code className="aka-code">bodylog-v1/v1.css</code> keeps the circleheads token set
              under <code className="aka-code">.bl1</code>. Rewriting a hundred and fifty custom
            ...
            <p className="mt-2 text-13 font-light leading-relaxed text-muted-foreground">
              ...
              attribute rather than the site&apos;s <code className="aka-code">.dark</code>, because
