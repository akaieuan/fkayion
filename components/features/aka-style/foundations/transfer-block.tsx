...
export function TransferSection() {
  return (
        <section className="mt-16">
          ...
          <pre tabIndex={0} className="mt-6 overflow-x-auto aka-card-well p-5 font-mono text-11 leading-relaxed text-foreground/80">
            {`/* globals.css */
:root {
...
@layer components {
  ...
  .aka-ink-quiet { color: color-mix(in srgb, var(--foreground) 62%, transparent); }
          ...
          <pre tabIndex={0} className="mt-3 overflow-x-auto aka-card-well p-5 font-mono text-11 leading-relaxed text-foreground/80">
            {`// tailwind.config.cjs
module.exports = {
  darkMode: ['class'],
