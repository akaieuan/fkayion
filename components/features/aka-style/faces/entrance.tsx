  ...
  return (
        <section className="mt-16">
          ...
          <p className="aka-standfirst">
            ...
            <code className="aka-code">once</code> assembles on first view and stops.{' '}
            <code className="aka-code">shimmer</code> adds a ~3Hz twinkle on ~4% of cells, enough to
          ...
          <div className={`${cell} mt-6`}>
            <div className="flex flex-wrap items-center justify-center gap-12 py-2">
              <div className="flex flex-col items-center gap-2.5">
                ...
                <span className="aka-label">once</span>
              </div>
              <div className="flex flex-col items-center gap-2.5">
                <PixelHead size={110} grid={22} once shimmer />
                <span className="aka-label">once + shimmer</span>
              </div>
              <div className="flex flex-col items-center gap-2.5">
                <PixelHead size={110} grid={22} still />
                <span className="aka-label">still</span>
              </div>
            </div>
          </div>
        </section>
