          ...
          <div className="flex items-start gap-3 mb-1.5">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[9px] px-2 py-0.5 rounded-full bg-border text-muted-foreground">
                  {TYPE_LABELS[p.type]}
                </span>
              </div>
              {p.description && (
            ...
            <div className="mb-5">
              ...
              <div className="flex flex-col gap-1">
                {p.chats.map((c) => (
                  ...
                  >
                    <MessageCircle size={14} className="text-muted-foreground/75" />
                    <div className="flex-1">
        ...
        <div className="w-[300px] shrink-0 border-l border-border p-5 overflow-auto">
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <span className="text-[10px] text-muted-foreground/75">Only you</span>
            </div>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button className="bg-transparent border-none cursor-pointer p-0 flex">
                <Plus size={13} className="text-muted-foreground/75" />
              </button>
            </div>
            {p.files.length === 0 ? (
              <div className="p-3 border border-dashed border-border rounded-lg text-center">
                <div className="text-[11px] text-muted-foreground/75">No files yet</div>
              </div>
            ) : (
                ...
                {p.files.map((f) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-[10px] text-muted-foreground/75">{f.size}</div>
                      <span
          ...
          {/* Dates */}
          <div className="mt-4 pt-3 border-t border-border text-[10px] text-muted-foreground/75 flex flex-col gap-1">
