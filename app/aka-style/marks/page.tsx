    ...
    <div className="min-h-screen bg-background px-6 py-16">
      <article className="mx-auto max-w-3xl">
        ...
        <section className="mt-16">
          ...
          <p className="mt-2 max-w-xl text-[13px] font-light leading-relaxed text-muted-foreground">
            The hero variant. Same disc grammar, but each reform reveals a different discipline
            rather than a face: AI spark, code brackets, an eighth note, an isometric cube, a
            terminal prompt, a pen stroke. The dissolve <em>is</em> the discipline change.
          </p>
