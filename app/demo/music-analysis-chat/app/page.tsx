...
import type { Message, ArtifactData, Block, Project } from '@/components/replicas/music-chat-comp/types';
import { uid } from '@/components/replicas/music-chat-comp/uid';
import { ART } from '@/components/replicas/music-chat-comp/data/artists';
import { SEED_PROJECTS } from '@/components/replicas/music-chat-comp/data/projects';
import { api } from '@/components/replicas/music-chat-comp/mock-api';
import { Sidebar } from '@/components/replicas/music-chat-comp/Sidebar';
import { ChatView } from '@/components/replicas/music-chat-comp/ChatView';
import { AnalyticsView } from '@/components/replicas/music-chat-comp/AnalyticsView';
import { ArtistsView } from '@/components/replicas/music-chat-comp/ArtistsView';
import { ArtifactsGallery } from '@/components/replicas/music-chat-comp/ArtifactsGallery';
import { ArtifactPanel } from '@/components/replicas/music-chat-comp/ArtifactPanel';
import { ProjectsListView } from '@/components/replicas/music-chat-comp/ProjectsListView';
import { ProjectDashboard } from '@/components/replicas/music-chat-comp/ProjectDashboard';
