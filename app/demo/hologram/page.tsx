...
/plugin install hologram`}
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              guided skills as the plugin&apos;s front door (v0.5). Still on the table, built on the
              stable Asset API: an offline/headless render path (no running Blender), render
