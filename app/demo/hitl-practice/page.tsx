          ...
          <div className="mt-10 space-y-10 text-[15px] font-light leading-relaxed text-muted-foreground">
            <section className="space-y-3">
              ...
              <p>
                ...
                evidence and citation UX, and the copy conventions that make agentic tools legible.
                I spent three and a half years doing this at{' '}
            ...
            <section className="rounded-xl border border-border/80 bg-muted/15 px-5 py-4">
              ...
              <p className="mt-2 text-[14px] leading-relaxed text-foreground/85">
                Everything on this site rehearses the same discipline that ships in product: the
                HITL-AI pages for primitive comparison, the Kit and the Kraa write-ups for the
                argument and the field notes. If you want the full index, it&apos;s all on the{' '}
