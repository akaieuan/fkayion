...
import inertialDashboard from '@/public/inertial/inertial-dashboard.png'
import visualizerPoster from '@/public/visualizer-eden/visualizer-eden-preview-poster.jpg'
/*
 ...
 */
import howIWork from '@/public/how-i-work/how-i-work-card.webp'
...
export const PROJECTS: ProjectCardItem[] = [
  ...
  },
  {
    ...
    description:
      'The design language everything here is built from, stated as nine constraints rather than preferences. Tokens in OKLCH, one type scale, server-rendered primitives, and a live specimen that cannot drift from what ships.',
    href: '/demo/aka-style',
